...
export const reviews = [
    {
        ...
        rating: 4.5,
        feedback: "I must admit, I was initially skeptical about purchasing this product online. However, upon receiving it, I was blown away by the meticulous attention to detail and the exceptional quality it possesses. Every aspect, from the design to the craftsmanship, reflects a level of dedication that exceeded my expectations. "
    },
    {
        imgURL: customer2,
